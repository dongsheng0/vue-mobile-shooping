  ...
  methods: {
    ...
    genOptions: function genOptions() {
      ...
      return this.options.map(function (option, index) {
        ...
        return h("li", helper_default()([{}, data]), [_this2.allowHtml ? '' : text]);
      });
    }
  },
  render: function render() {
...
/* harmony default export */ var sidebar = (sidebar_createComponent({
  ...
  render: function render() {
    var h = arguments[0];
    return h("div", {
      "class": [sidebar_bem(), BORDER_TOP_BOTTOM]
    }, [this.slots()]);
  }
}));
  ...
  computed: {
    ...
    quotaText: function quotaText() {
      ...
      if (quotaText) {
        ...
        text = Sku_t('quotaLimit', this.quota);
      }
    ...
    onOverLimit: function onOverLimit(data) {
      ...
      if (action === 'minus') {
        ...
        if (limitType === Sku_QUOTA_LIMIT) {
          var msg = Sku_t('quotaLimit', quota);
          if (quotaUsed > 0) msg += "\uFF0C" + Sku_t('quotaCount', quotaUsed);
          es_toast(msg);
        } else {
...
var version = '2.1.8';
var components = [action_sheet, address_edit, address_list, es_area, es_button, card, cell, cell_group, es_checkbox, checkbox_group, circle, col, collapse, collapse_item, contact_card, contact_edit, contact_list, count_down, es_coupon, coupon_cell, coupon_list, datetime_picker, dialog, divider, dropdown_item, dropdown_menu, field, goods_action, goods_action_button, goods_action_icon, grid, grid_item, es_icon, es_image, image_preview, index_anchor, index_bar, es_info, es_list, es_loading, nav_bar, notice_bar, notify, number_keyboard, es_overlay, pagination, panel, password_input, es_picker, popup, es_progress, pull_refresh, es_radio, radio_group, es_rate, row, search, sidebar, sidebar_item, skeleton, es_sku, slider, step, stepper, steps, es_sticky, submit_bar, swipe, swipe_cell, swipe_item, es_switch, switch_cell, tab, tabbar, tabbar_item, tabs, es_tag, es_toast, tree_select, uploader];
